...
export interface ApiFunction<T> {
    (data?: Record<string, any> | undefined, config?: Record<string, any> | undefined): Promise<{
        res?: T;
        rawRes?: any;
        _status?: string;
        _error?: string;
...
export interface HttpClientOption {
    ...
    afterResponse?(res: any, req: Req, httpOption: Record<string, any>): Promise<any> | void;
